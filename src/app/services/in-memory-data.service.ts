...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const calltypes = [
      {
        calltype_id: '155519617ab6',
        name: 'BFQ'
      },
      {
        calltype_id: '99cb04868b9e',
        name: 'CCAT'
      },
      {
        calltype_id: '3becd45f709f',
        name: 'Commitment'
      },
      {
        calltype_id: '3e247b117348',
        name: 'Language'
      },
      {
        calltype_id: '0e655f55ea30',
        name: 'Skills'
      },
      {
    ...
    const transcripts = {
      ...
      calltype_id: 'f44785ceA',
      call_datetime: '2020-07-20 01:00:45',
      duration: 238900,
      agent: [
        {
          agent_id: '7f63308ac',
      ...
      script: [
        ...
        },
        {
          ...
          matching_sentence: 'I\'m an executive recruiter from Crossover and I\'m calling about your application for the Software Architect.'
        },
        {
          order: 3,
          similarity: 0.23,
          sentence: 'Do you remember this application?',
          matching_sentence: 'Do you remember how long I think perfect perfect.'
        },
        {
          order: 4,
          similarity: 0.95,
          sentence: 'So first of all, I should let you know that this call is being recorded for quality and training purposes.',
          matching_sentence: 'So first of all, I should let you know that this call is being recorded for quality and training purposes so Luke.'
        },
        {
          order: 5,
          similarity: 0.35,
          sentence: 'I want to check if you are still interested in continuing with this application?',
          matching_sentence: 'So, are you still interested in continuing with the application for Angular?'
        },
        {
          order: 6,
          similarity: 0.52,
          ...
          matching_sentence: 'Do you think you would be able to complete the remaining step by 27th of July your commitment date?'
        },
        {
          order: 7,
          similarity: 0.18,
          sentence: 'Have you seen the links with further instructions in your email?',
          matching_sentence: 'You haven\'t seen the links in your application in I mean in your email.'
        },
        {
          order: 8,
          similarity: 0.48,
          sentence: 'Do you have any question related to this role or Crossover that I can help you with before we close the call?',
          matching_sentence: 'Did you have any questions that I can help you with before closing the call?'
        },
        {
          order: 9,
          similarity: 0.21,
          sentence: 'Perfect... I wish you good luck and hope to see you soon in our organization.',
          matching_sentence: 'So, I wish you good luck and let me start anything.'
        },
        {
          order: 10,
          similarity: 1,
          sentence: 'Have a good day.',
          matching_sentence: 'Have a good day.'
        }
      ],
      transcript: [
        {
        ...
        },
        {
          ...
          matching_sentence: 'I\'m an executive recruiter from Crossover and I\'m calling you about your recent application for the Software Architect - Angular role.',
          channel: 1,
          timeFrom: 38,
          timeTo: 50
        },
        {
          ...
          matching_sentence: 'Do you remember this application?',
          channel: 0,
          timeFrom: 55,
          timeTo: 70
        },
        ...
        },
        {
          ...
          matching_sentence: 'So first of all, I should let you know that this call is being recorded for quality and training purposes.',
          channel: 1,
          timeFrom: 78,
          timeTo: 102
        },
        ...
        },
        {
          ...
          matching_sentence: 'I want to check if you are still interested in continuing with this application?',
          channel: 1,
          timeFrom: 193,
          timeTo: 198
        },
        ...
        },
        {
          ...
          matching_sentence: 'Do you think that you would be able to complete the remaining step by :commitment-date: which you set as your commitment date?',
          channel: 1,
          timeFrom: 207,
          timeTo: 216
        },
        ...
        },
        {
          ...
          matching_sentence: 'Have you seen the links with further instructions in your email?',
          channel: 1,
          timeFrom: 241,
          timeTo: 250
        },
        ...
        },
        {
          ...
          matching_sentence: 'Do you have any question related to this role or Crossover that I can help you with before we close the call?',
          channel: 1,
          timeFrom: 388,
          timeTo: 398
        },
        ...
        },
        {
          ...
          matching_sentence: 'Perfect... I wish you good luck and hope to see you soon in our organization.',
          channel: 1,
          timeFrom: 411,
          timeTo: 415
        },
    ...
    return { agents, calltypes, calls, transcripts };
  }
}
